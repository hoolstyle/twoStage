    ...
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="username" name="poststitle" required="" lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  name="postscontent" required=""
                       autocomplete="off" class="layui-input">
            </div>
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label"><span class="x-red">*</span>环境</label>
            <div class="layui-input-block">
                <c:forEach items="${selects}" var="item">
                    <input type="radio" name="poststype" lay-skin="primary" value="${item.typeid}" title="${item.typename}">
                </c:forEach>
            </div>
        </div>
